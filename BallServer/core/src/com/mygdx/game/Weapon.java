...
public class Weapon extends Entity {
    ...
    public Weapon(String texture_path,Entity owner) {
        super(texture_path);
        this.owner = owner;
    ...
    class WeaponStats {
        ...
        public WeaponStats(String name,String projectile_name,float fire_rate) {
            this.name = name;
            this.projectile_name = projectile_name;
